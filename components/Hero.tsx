      ...
      <div className="grid lg:grid-cols-[1.05fr_0.95fr] min-h-[100svh]">
        ...
        <div className="relative z-10 flex flex-col justify-center px-6 sm:px-10 py-28 lg:py-0 order-2 lg:order-1">
          ...
          >
            ...
            Training like it&apos;s a competition. Three disciplines, one
            standard.
          </motion.div>
        ...
        <div className="relative order-1 lg:order-2 h-[52vh] lg:h-auto overflow-hidden">
          ...
          >
            ...
            {/* fade to carbon so it blends with the page, and toward the text column on desktop */}
          ...
          {/* wireframe accent, sitting over the image corner */}
          {/* <div className="absolute -top-10 -left-10 w-64 h-64 sm:w-80 sm:h-80 opacity-60 mix-blend-screen pointer-events-none">
            <Scene />
          </div> */}
        </div>
      </div>
